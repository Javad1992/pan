...
const DetailChecklistRequestPage = ({ archive }) => {
  ...
  return (
    <Container>
      <Row>
        <HeaderTitle>جزییات بازدید انجام شده</HeaderTitle>

        <Button
          small
          onClick={() => dispatch(openArchiveModal(detailVisit?.visitCode))}
        >
          بایگانی
        </Button>
      </Row>
...
export default DetailChecklistRequestPage;
