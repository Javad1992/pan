...
const ExpertEducationManagementDetail = () => {
  ...
  return (
    <div>
      <div>{modal}</div>
      <Wrapper>
        <HeaderTitle>جزییات کارشناس تایید شده</HeaderTitle>
      </Wrapper>
      <Content>
          ...
          <Space>
            ...
            <div style={{ margin: ".2rem 0" }}>
              ...
              <Typography>
                ...
                >
                  برای انجام بازدید وسیله نقیله دارید ؟{" "}
                </SubTitle>
              ...
              <Typography>
                ...
                >
                  آیا عضو سازمان نظام مهندسی کشاورزی هستید؟{" "}
                </SubTitle>
      ...
      <Content>
        <ToggleText title="اطلاعات تکمیلی">
          ...
          <Space>
            <Typography>
              <span style={{ color: "red" }}>*</span> اینجانب مسئولیت ثبت
              اطلاعات فوق را برعهده گرفته، اساسنامه و سوگندنامه را مطالعه کرده و
              با قوانین و تعهدات آن موافق هستم.
            </Typography>
          </Space>
        </ToggleText>
      </Content>
